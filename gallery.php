...
<!--gallery starts here-->
<section  id="gallery">
    <h1 class="heading"> <span>Label Gallery</span> </h1>
  ...
  <div class="wrapper">
    ...
    <nav>
      <div class="items">
        ...
        <span class="item" data-name="Custom Labels">Custom Labels</span>
        <span class="item" data-name="Customer Stickers">Customer Stickers</span>
        <span class="item" data-name="Mason Jar Labels and Stickers">Mason Jar Labels and Stickers</span>
        <span class="item" data-name="Candle Labels">Candle Labels</span>
        <span class="item" data-name="Clothing Labels">Clothing Labels</span>
      </div>
    </nav>
    <!-- filter Images -->
    <div class="gallery">
      <div class="image" data-name="Custom Labels"><span><img src="image/label-1.png" alt=""></span></div>
      <div class="image" data-name="Candle Labels"><span><img src="image/label-2.png" alt=""></span></div>
      <div class="image" data-name="Candle Labels"><span><img src="image/label-3.png" alt=""></span></div>
      <div class="image" data-name="Customer Stickers"><span><img src="image/label-4.png" alt=""></span></div>
      <div class="image" data-name="Customer Stickers"><span><img src="image/label-5.png" alt=""></span></div>
      <div class="image" data-name="Mason Jar Labels and Stickers"><span><img src="image/label-6.png" alt=""></span></div>
      <div class="image" data-name="Clothing Labels"><span><img src="image/label-1.png" alt=""></span></div>
      <div class="image" data-name="Candle Labels"><span><img src="image/label-2.png" alt=""></span></div>
    </div>
  </div>
